...
The list of commands is collected from `dev/varibles/command_list.txt`.

## Main bot: user commands
...
- `/edit_currency` — edit currency rate
- `/add_achievement` — create new achievement
- `/grant_achievement` — grant achievement to user
- `/revoke_achievement` — revoke achievement from user
...
- `/start` — start the bank bot
- `/bank` — open the Imperial Bank menu

## Card bot: user commands

- `/start` — start the card bot
- `/help` — help with the card game
- `/roll` — buy and open a pack
...
- `/cg_edit_card` — edit an existing card
