...
def thx_for_message(user_name: str, mes_type: str) -> str:
    ...
    secret_variants_v = [
        ...
        f"И снова ты! {user_name}, тебе самому не надолело??? Лаааадно, отправила пост...",
    ]
    ...
    variants_q = [
        ...
        f"О, отличный вопрос, {user_name}. Сама жду, что скажет админ!",
        f"Записала ваш вопрос, {user_name}. Надеюсь, админ не будет злиться :)",
        ...
        f"{user_name}, ты хоть про подвалы так не спроси... Отправила вопрос, ждём ответ!",
    ]
    FUN = random()
